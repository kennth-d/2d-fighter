...
export const F002 = {
    push: {
        ...
        HEAVY_ATTACK: new Array(7).fill([]).map(() => {return defaultPushBox}),
        SP_1:         new Array(8).fill([]).map(() => {return defaultPushBox}),
    ...
    hit: {
        ...
        HEAVY_ATTACK: [[], [-25, 20, 15, 5], [], [], [], [], []],
        SP_1: [[], [], [], [], [-11, 17, 33, 5], [-11, 17, 33, 5], [], []],
        sp_2:         new Array(10).fill([]).map(() => {[]}),
    },
    hurt: {
        ...
        HEAVY_ATTACK: [
            idleHurtBoxes,
            [[-23, 23, 7, 4], [-16, 19, 12, 7], [-11, 11, 14, 11]],
            [[-23, 23, 7, 4], [-16, 19, 12, 7], [-11, 11, 14, 11]],
            [[-23, 23, 7, 4], [-16, 19, 12, 7], [-11, 11, 14, 11]],
            [[-10, 29, 7, 7], [-7, 21, 11, 10], [-7, 11, 11, 11]],
            idleHurtBoxes,
            idleHurtBoxes,
        ],
        SP_1: [
            [[1, 29, 7, 7], [6, 20, 9, 8], [8, 10, 16, 9]],
            [[3, 27, 7, 7], [9, 19, 11, 9], [9, 10, 15, 10]],
            [[4, 25, 7, 7], [10, 17, 11, 8], [9, 10, 15, 10]],
            [[4, 25, 7, 7], [10, 17, 11, 8], [9, 10, 15, 10]],
            [[-11, 21, 9, 9], [-1, 18, 10, 7], [6, 11, 18, 11]],
            [[-11, 21, 9, 9], [-1, 18, 10, 7], [6, 11, 18, 11]],
            [[-5, 26, 7, 7], [2, 18, 14, 8], [8, 10, 16, 9]],
            [[1, 29, 7, 7], [6, 20, 9, 8], [8, 10, 16, 9]],
        ],
